...
/**
 * Rattrapage : remplit stripe_price_id pour les plans existants (après fixtures ou si migration précédente déjà passée).
 */
final class Version20260304124000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Fill stripe_price_id for existing plans (catch-up)';
    }
